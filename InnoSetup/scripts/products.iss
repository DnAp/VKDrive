...
ru.depdownload_msg=Требуется установка следующих приложений перед инсталляцией:%n%n%1%nЗагрузить и установить сейчас?
...
ru.depinstall_description=Пожалуйста, подождите, пока на вашем компьютере устанавливаются зависимости.
...
ru.depinstall_missing=Нужно установить %1. Пожалуйста, установите %1 и снова запустите программу установки.
...
ru.depinstall_error=Произошла ошибка при установке зависимостей. Пожалуйста, перезагрузите компьютер и запустите приложение снова или установите следующие зависимости вручную:%n
